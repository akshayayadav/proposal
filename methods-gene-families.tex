...
\begin{document}
	...
	\section{Specific aims}
		\begin{enumerate}
			\item Developing and assessing pair classification based method for detecting under-clustered gene families
			
			\item Developing and assessing tree based and domain based methods for detecting over-clustered gene families
			
			\item Workflow for obtaining consensus families from multiple family sets
	...
	\section{Objective 1: Pair classification based family scoring} 
	...
	\section{Objective 2: Methods for detecting over-clustered families}	
	...
	\pagebreak
	\section{Objective 3: Building high-quality consensus set of families by comparing family sets}
